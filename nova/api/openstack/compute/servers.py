...
# CERN
        self._cern_sanitize_hostname(name)
        self._cern_windows_hostname(context, image_uuid)
        metadata = server_dict.get('metadata', {})
        self._cern_validate_metadata(self, metadata)
        #self._cern_validate_numinstances(self, num_instances)
# CERN
